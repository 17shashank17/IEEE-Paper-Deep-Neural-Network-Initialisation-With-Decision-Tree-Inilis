...
ntrees1=3
dropout_keep1=0.95
modelname1="class_bdjinn_test"
bmodel=djinn.DJINN_Classifier(ntrees1,maxdepth,dropout_keep1)
...
with cf.ProcessPoolExecutor() as p:
    p.submit(model.train,x_train,y_train,epochs=epochs,learn_rate=learnrate, batch_size=batchsize, 
                display_step=1, save_files=True, file_name=modelname, 
                save_model=True,model_name=modelname, random_state=1)
    p.submit(bmodel.fit,x_train,y_train, display_step=1, save_files=True, file_name=modelname1, 
            save_model=True,model_name=modelname1, random_state=1)
